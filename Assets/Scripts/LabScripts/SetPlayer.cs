...
public class SetPlayer : MonoBehaviour
{
    ...
    public void ChangePlayer()
    {
        ...
        else if (b == 61 || b == 62 || b == 49 || b == 50 || b == 53 || b == 54 || b == 57 || b == 58)
        {
        ...
        else if (b == 15 || b == 16 || b == 31 || b == 32 || b == 47 || b == 48 || b == 63 || b == 64)
        {
            gameDefinitions.ROOM = 8;
        }
        else if (b == 17 || b == 18 || b == 21 || b == 22 || b == 25 || b == 26 || b == 29 || b == 30)
        {
            gameDefinitions.ROOM = 5;
        }
        else if (b == 23 || b == 24 || b == 39 || b == 40 || b == 55 || b == 56 || b == 7 || b == 8)
        {
